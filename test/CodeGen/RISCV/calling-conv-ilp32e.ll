...
; RV32I-FPELIM:       # %bb.0:
; RV32I-FPELIM-NEXT:    addi sp, sp, -4
; RV32I-FPELIM-NEXT:    sw ra, 0(sp)
; RV32I-FPELIM-NEXT:    mv a2, a0
; RV32I-FPELIM-NEXT:    mv a0, a1
; RV32I-FPELIM-NEXT:    call __fixsfsi
; RV32I-FPELIM-NEXT:    add a0, a2, a0
; RV32I-FPELIM-NEXT:    lw ra, 0(sp)
; RV32I-FPELIM-NEXT:    addi sp, sp, 4
; RV32I-FPELIM-NEXT:    ret
;
; RV32I-WITHFP-LABEL: callee_float_in_regs:
; RV32I-WITHFP:       # %bb.0:
; RV32I-WITHFP-NEXT:    addi sp, sp, -8
; RV32I-WITHFP-NEXT:    sw ra, 4(sp)
; RV32I-WITHFP-NEXT:    sw s0, 0(sp)
; RV32I-WITHFP-NEXT:    addi s0, sp, 8
; RV32I-WITHFP-NEXT:    mv a2, a0
; RV32I-WITHFP-NEXT:    mv a0, a1
; RV32I-WITHFP-NEXT:    call __fixsfsi
; RV32I-WITHFP-NEXT:    add a0, a2, a0
; RV32I-WITHFP-NEXT:    lw s0, 0(sp)
; RV32I-WITHFP-NEXT:    lw ra, 4(sp)
; RV32I-WITHFP-NEXT:    addi sp, sp, 8
...
; RV32I-FPELIM:       # %bb.0:
; RV32I-FPELIM-NEXT:    addi sp, sp, -8
; RV32I-FPELIM-NEXT:    sw ra, 4(sp)
; RV32I-FPELIM-NEXT:    sw s0, 0(sp)
; RV32I-FPELIM-NEXT:    addi s0, sp, 8
; RV32I-FPELIM-NEXT:    lw a0, 8(s0)
; RV32I-FPELIM-NEXT:    lw a1, 0(s0)
; RV32I-FPELIM-NEXT:    add a0, a1, a0
; RV32I-FPELIM-NEXT:    addi sp, s0, -8
; RV32I-FPELIM-NEXT:    lw s0, 0(sp)
...
; RV32I-WITHFP-NEXT:    sw s0, 0(sp)
; RV32I-WITHFP-NEXT:    addi s0, sp, 8
; RV32I-WITHFP-NEXT:    lw a0, 8(s0)
; RV32I-WITHFP-NEXT:    lw a1, 0(s0)
; RV32I-WITHFP-NEXT:    a0, a1, a0
; RV32I-WITHFP-NEXT:    addi sp, s0, -8
; RV32I-WITHFP-NEXT:    lw s0, 0(sp)
; RV32I-WITHFP-NEXT:    lw ra, 4(sp)
; RV32I-WITHFP-NEXT:    addi sp, sp, 8
; RV32I-WITHFP-NEXT:    ret
...
; RV32I-FPELIM:       # %bb.0:
; RV32I-FPELIM-NEXT:    addi sp, sp, -24
; RV32I-FPELIM-NEXT:    sw ra, 20(sp)
; RV32I-FPELIM-NEXT:    sw s0, 16(sp)
; RV32I-FPELIM-NEXT:    addi s0, sp, 24
...
; RV32I-FPELIM-NEXT:    addi sp, s0, -24
; RV32I-FPELIM-NEXT:    lw s0, 16(sp)
; RV32I-FPELIM-NEXT:    lw ra, 20(sp)
; RV32I-FPELIM-NEXT:    addi sp, sp, 24
; RV32I-FPELIM-NEXT:    ret
;
; RV32I-WITHFP-LABEL: caller_float_on_stack:
; RV32I-WITHFP:       # %bb.0:
; RV32I-WITHFP-NEXT:    addi sp, sp, -24
...
; RV32I-WITHFP-NEXT:    addi sp, s0, -24
